...
class GameServerObjectMeta(object):
    ...
    def __init__(self, name=None, namespace=None, uid=None, resource_version=None, generation=None, creation_timestamp=None, deletion_timestamp=None, annotations=None, labels=None):  # noqa: E501
